...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href="#home" className="text-emerald-600 hover:text-emerald-700 px-3 py-2 text-sm font-medium transition-colors">
                  Home
                </a>
                <a href="#dashboard" className="text-gray-600 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">
                  Dashboard
                </a>
                <a href="#developer" className="text-gray-600 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">
                  Developer
                </a>
              </div>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#home" className="text-emerald-600 block px-3 py-2 text-base font-medium">Home</a>
              <a href="#dashboard" className="text-gray-600 hover:text-emerald-600 block px-3 py-2 text-base font-medium">Dashboard</a>
              <a href="#developer" className="text-gray-600 hover:text-emerald-600 block px-3 py-2 text-base font-medium">Developer</a>
            </div>
          </div>
        )}
      </nav>
      ...
      {/* Hero Section */}
      <section id="home" className="relative bg-gradient-to-br from-emerald-50 to-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
